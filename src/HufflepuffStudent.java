public class HufflepuffStudent extends HogwartsStudent{
    ...
    public void compareHufflepuff(HufflepuffStudent hufflepuffStudent) {
        ...
        if (ability1 > ability2) {
            ...
            System.out.printf("Пуффендуец %s такой же пуффендуец %s: %d VS %d%n", hufflepuffStudent.getName(), getName(), ability1, ability2);
        }
    }

    @Override
    public String toString() {
        return String.format("%s; Пуффендуец " + getName() +
                " трудолюбие =" + diligence +
                ", верность =" + loyalty +
                ", честь =" + honesty, super.toString());
    }
}
