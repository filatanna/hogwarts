public class GryffindorStudent extends HogwartsStudent {
    ...
    public void compareGriffindor(GryffindorStudent gryffindorStudent){
        ...
        if ( ability1 > ability2) {
            ...
            System.out.printf("Гриффиндорец %s такой же гриффиндорец %s: %d VS %d%n", gryffindorStudent.getName(), getName(), ability1, ability2 );
        }
    ...
    public String toString() {
        return String.format("%s; Гриффиндорец " + getName() +
                " благородство =" + nobility +
                ", честь =" + honor +
                ", храбрость =" + bravery, super.toString())
                ;
    }
}
