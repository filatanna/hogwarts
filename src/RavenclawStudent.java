public class RavenclawStudent extends HogwartsStudent{
    ...
    public void compareRavenclaw(RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 > ability2) {
            ...
            System.out.printf("Когтевранец %s такой же когтевранец %s: %d VS %d%n", ravenclawStudent.getName(), getName(), ability1, ability2);
        }
    }

    @Override
    public String toString() {
        return String.format("%s; Когтевранец " + getName() +
                " ум =" + cleverness +
                ", мудрость =" + wisdom +
                ", остроумие =" + wit +
                ", творчество =" + creativity, super.toString());
    }
}
